...
<h3>Obierz zarząd</h3>
	<table class="form-table">
		<tr>
			...
			<td>
                <label>
				    <input type="checkbox" name="president" id="president" value="yes" <?php if (esc_attr(get_the_author_meta('president', $user->ID)) == true) {
    echo 'checked';
}
            ?> />
        ...
        <tr>
            ...
            <td>
                <label>
				    <input type="checkbox" name="member_of_managment_board" id="member_of_managment_board" value="yes" <?php if (esc_attr(get_the_author_meta('member_of_managment_board', $user->ID)) == true) {
    echo 'checked';
}
            ?> />
    ...
    ?>
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <label>
				        <input type="checkbox" name="show_mail" id="show_mail" value="yes" <?php if (esc_attr(get_the_author_meta('show_mail', $user->ID)) == true) {
    echo 'checked';
}
    ?> />
            ...
            <tr>
                ...
                <td><input type="text" name="github_profile" value="<?php echo esc_attr(get_the_author_meta('github_profile', $user->ID));
    ?>" class="regular-text" /></td>
            </tr>

            <tr>
                <th><label for="twitter_profile">Twitter Profile</label></th>
                <td><input type="text" name="twitter_profile" value="<?php echo esc_attr(get_the_author_meta('twitter_profile', $user->ID));
    ?>" class="regular-text" /></td>
            </tr>

            <tr>
                <th><label for="google_profile">Facebook Profile</label></th>
                <td><input type="text" name="facebook_profile" value="<?php echo esc_attr(get_the_author_meta('facebook_profile', $user->ID));
    ?>" class="regular-text" /></td>
            </tr>
        </table>
    <?php
