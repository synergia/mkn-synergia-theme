  ...
  <div class="gl-md-9 gl-cell">
    ...
    <div class="tabs">
      ...
      <nav class="tabs-nav" role="navigation">
        <ul>
          <li><label for="tab-1">Ukończone (<?php echo $current_member->number_of_finished_projects; ?>)</label></li>
          <li><label for="tab-2">Realizowane (<?php echo $current_member->number_of_in_progress_projects; ?>)</label></li>
